    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">toko tas </a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li>
							<a href="tampil-data-produk.php"><span class="glyphicon glyphicon-user"></span>data produk</a>
						</li>
            <li>
							<a href="tampil-pembeli.php"><span class="glyphicon glyphicon-user"></span> pembeli</a>
						</li>
               <li>
